...
input {
    keyboard {
        xkb {
            ...
            // IMPORTANT: Do not set compose:ralt here.
            // On DE/AT layouts RightAlt is AltGr (Level3), used for { } [ ] \\ | @ ~, etc.
            // Using it as Compose breaks normal programming symbols.
            options "grp:win_space_toggle,compose:menu,ctrl:nocaps"
